...
// OfferContentErrorDTO Сообщение об ошибке.
...
func (o *OfferContentErrorDTO) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOfferContentErrorDTO)
