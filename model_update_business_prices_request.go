...
// UpdateBusinessPricesRequest Запрос на установку дефолтных цен на товары.
...
func (o *UpdateBusinessPricesRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateBusinessPricesRequest)
