...
type GoodsStatsGoodsDTO struct {
	...
	Tariffs []GoodsStatsTariffDTO `json:"tariffs,omitempty"`
...
// SetTariffs gets a reference to the given []GoodsStatsTariffDTO and assigns it to the Tariffs field.
