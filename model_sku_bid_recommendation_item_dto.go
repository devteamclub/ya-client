...
// GetBidRecommendations returns the BidRecommendations field value if set, zero value otherwise.
...
// GetPriceRecommendations returns the PriceRecommendations field value if set, zero value otherwise.
...
func (o SkuBidRecommendationItemDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BidRecommendations) {
		toSerialize["bidRecommendations"] = o.BidRecommendations
	}
	if !IsNil(o.PriceRecommendations) {
		toSerialize["priceRecommendations"] = o.PriceRecommendations
	}
	return toSerialize, nil
}

func (o *SkuBidRecommendationItemDTO) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSkuBidRecommendationItemDTO)
