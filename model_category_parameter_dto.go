...
// GetValueRestrictions returns the ValueRestrictions field value if set, zero value otherwise.
...
func (o CategoryParameterDTO) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecommendationTypes) {
	...
	if !IsNil(o.ValueRestrictions) {
		toSerialize["valueRestrictions"] = o.ValueRestrictions
	}
	return toSerialize, nil
}

func (o *CategoryParameterDTO) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCategoryParameterDTO)
