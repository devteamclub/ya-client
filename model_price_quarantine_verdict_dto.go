...
type PriceQuarantineVerdictDTO struct {
	...
	Params []PriceQuarantineVerdictParameterDTO `json:"params,omitempty"`
}
...
// SetParams gets a reference to the given []PriceQuarantineVerdictParameterDTO and assigns it to the Params field.
