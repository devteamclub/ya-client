...
// OutletWorkingScheduleDTO Список режимов работы точки продаж. Обязательный параметр. 
...
func (o *OutletWorkingScheduleDTO) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOutletWorkingScheduleDTO)
