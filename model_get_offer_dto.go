...
// GetSellingPrograms returns the SellingPrograms field value if set, zero value otherwise.
...
func (o *GetOfferDTO) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetOfferDTO)
