...
// UpdateOfferContentResultDTO Ошибки и предупреждения, касающиеся переданных характеристик товара.
...
func (o *UpdateOfferContentResultDTO) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateOfferContentResultDTO)
