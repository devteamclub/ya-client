...
type GetOutletsResponse struct {
	...
	Outlets []FullOutletDTO `json:"outlets,omitempty"`
...
// GetOutlets returns the Outlets field value if set, zero value otherwise.
func (o *GetOutletsResponse) GetOutlets() []FullOutletDTO {
	if o == nil || IsNil(o.Outlets) {
...
// GetOutletsOk returns a tuple with the Outlets field value if set, nil otherwise
...
// SetOutlets gets a reference to the given []FullOutletDTO and assigns it to the Outlets field.
