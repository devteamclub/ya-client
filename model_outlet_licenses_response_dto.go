...
type OutletLicensesResponseDTO struct {
	// Список лицензий.
	Licenses []FullOutletLicenseDTO `json:"licenses,omitempty"`
}
...
// SetLicenses gets a reference to the given []FullOutletLicenseDTO and assigns it to the Licenses field.
