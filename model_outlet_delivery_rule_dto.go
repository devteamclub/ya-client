...
type OutletDeliveryRuleDTO struct {
	// Стоимость самовывоза из точки продаж. Обязательный параметр. 
	...
	// Идентификатор службы доставки товаров в точку продаж. Идентификаторы и наименования служб доставки можно получить с помощью ресурса `GET /delivery/services`. 
