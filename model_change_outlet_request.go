...
type ChangeOutletRequest struct {
	...
	// Номера телефонов точки продаж. Передавайте в формате: `+7 (999) 999-99-99`. Обязательный параметр. 
...
// GetDeliveryRules returns the DeliveryRules field value if set, zero value otherwise.
...
func (o *ChangeOutletRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varChangeOutletRequest)
