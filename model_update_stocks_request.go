...
// UpdateStocksRequest Запрос на изменение информации по стокам.
type UpdateStocksRequest struct {
	// Данные об остатках товаров. 
	Skus []StockDTO `json:"skus"`
}
...
func (o *UpdateStocksRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateStocksRequest)
