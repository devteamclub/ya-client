...
type OutletWorkingScheduleItemDTO struct {
	...
	// Точка продаж работает c указанного часа. Формат: `ЧЧ:ММ`. Обязательный параметр. 
	StartTime string `json:"startTime"`
	// Точка продаж работает до указанного часа. Формат: `ЧЧ:ММ`. Обязательный параметр. 
...
func (o *OutletWorkingScheduleItemDTO) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOutletWorkingScheduleItemDTO)
