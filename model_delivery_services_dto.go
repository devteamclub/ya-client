...
type DeliveryServicesDTO struct {
	...
	DeliveryService []DeliveryServiceInfoDTO `json:"deliveryService,omitempty"`
}
...
// SetDeliveryService gets a reference to the given []DeliveryServiceInfoDTO and assigns it to the DeliveryService field.
