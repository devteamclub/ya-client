...
type OfferPriceByOfferIdsListResponseDTO struct {
	// Страница списка цен.
	Offers []OfferPriceByOfferIdsResponseDTO `json:"offers,omitempty"`
...
// SetOffers gets a reference to the given []OfferPriceByOfferIdsResponseDTO and assigns it to the Offers field.
