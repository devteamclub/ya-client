...
// OrdersStatsPaymentSourceType Способ денежного перевода: - `BUYER` — оплата или возврат деньгами; - `CASHBACK` — оплата или возврат баллами кешбэка по подписке Яндекс Плюс; - `MARKETPLACE` — оплата или возврат купонами; - `SPASIBO` — оплата или возврат бонусами СберСпасибо. 
...
const (
	...
	SPASIBO OrdersStatsPaymentSourceType = "SPASIBO"
)
